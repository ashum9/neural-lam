...
- Improve development environment setup instructions in README: add link to Python venv docs, clarify editable install, and test verification steps [#262](https://github.com/mllam/neural-lam/pull/262) @ashum9
