...
For development, we recommend using a virtual environment. See the [official Python venv documentation](https://docs.python.org/3/library/venv.html) for instructions.
...
To verify your environment, run all tests:
